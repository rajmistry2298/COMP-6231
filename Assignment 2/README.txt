...
3. In order to run Servers goto run configuration and select server file and in its Argument part enter "-ORBInitialPort 1050 -ORBInitialHost localhost" and apply it
   and Run files. Do this for all 3 server files: 
	a. NAServer.java
	b. EUServer.java
	c. ASServer.java
4. In order to run clients goto run configuration and select client file and in its Argument part enter "-ORBInitialPort 1050 -ORBInitialHost localhost" and apply it
