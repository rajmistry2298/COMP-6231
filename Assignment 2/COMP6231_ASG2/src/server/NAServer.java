...
public class NAServer {
	...
	public static void main(String[] args){
		try {
            ...
            final GameServerImpl gameServerImpl = new GameServerImpl(LocationConstants.NORTHAMERICA);
            ...
            final NameComponent path[] = ncRef.to_name(LocationConstants.NORTHAMERICA);
