...
public class LocationConstants {
	    ...
	    public static final String NORTHAMERICA_ADDRESS = "http://localhost:8080/NASever/" + LocationConstants.NORTHAMERICA;
	    public static final String EUROPE_ADDRESS = "http://localhost:8081/EUServer/" + LocationConstants.EUROPE;
	    public static final String ASIA_ADDRESS = "http://localhost:8082/ASServer/" + LocationConstants.ASIA;
