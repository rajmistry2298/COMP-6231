...
public class ASServer implements GameServer{
	
	public String serverLocation = LocationConstants.ASIA;
	...
	public ASServer() throws RemoteException,IOException{
	...
	public static void main(String[] args) {
		try {
			...
			final ASServer gameServerImpl = new ASServer();
	...
	private static void startUDPServer(final ASServer gameServer) {
    ...
    private static void processUDPRequest(final ASServer gameServer, final DatagramPacket dp) {
    	byte[] response;
        DatagramSocket socket = null;
