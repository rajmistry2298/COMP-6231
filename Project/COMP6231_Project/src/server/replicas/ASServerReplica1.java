...
public class ASServerReplica1 {

	public static void main(String[] args) {

		try {
			final List<String> replicaList = new ArrayList<>(Arrays.asList(LocationConstants.ASIA_REPLICA_1,
														   				   LocationConstants.ASIA_REPLICA_2, 
														   				   LocationConstants.ASIA_REPLICA_3));
			
			final ActivityLoggerService activityLogger = new ActivityLoggerService(FileConstants.SERVER_LOG_FILE_PATH + LocationConstants.ASIA + "/" + args[0].trim()+FileConstants.FILE_TYPE);
