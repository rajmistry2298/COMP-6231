...
public class EUServerReplica3 {

	public static void main(String[] args) {

		try {
			final List<String> replicaList = new ArrayList<>(Arrays.asList(LocationConstants.EUROPE_REPLICA_1,
														   				   LocationConstants.EUROPE_REPLICA_2, 
														   				   LocationConstants.EUROPE_REPLICA_3));
			
			final ActivityLoggerService activityLogger = new ActivityLoggerService(FileConstants.SERVER_LOG_FILE_PATH + LocationConstants.EUROPE + "/" + args[0].trim()+FileConstants.FILE_TYPE);
