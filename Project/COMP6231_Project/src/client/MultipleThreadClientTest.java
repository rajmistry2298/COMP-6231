...
public class MultipleThreadClientTest implements Runnable{
	...
	public static void main(String[] args) {
        ...
        System.out.println(normalObject.server.getPlayerStatus("93.3.3.4"));
	}
	...
	public void run() {
		...
		System.out.println("Thread :"+Thread.currentThread().getId()+" : " +server.playerSignIn("newusername", "newpassword", "132.2.2.2"));
		System.out.println("Thread :"+Thread.currentThread().getId()+" : " +server.getPlayerStatus("132.2.2.2"));
		System.out.println("Thread :"+Thread.currentThread().getId()+" : " +server.playerSignOut("newusername","132.2.2.2"));
		System.out.println("Thread :"+Thread.currentThread().getId()+" : "+server.transferAccount("newusername", "newpassword" , "132.2.2.2", "182.2.2.2"));
		System.out.println("Thread :"+Thread.currentThread().getId()+" : "+server.suspendAccount("newusername","132.2.2.2"));		
		System.out.println("Thread :"+Thread.currentThread().getId()+" : "+server.suspendAccount("rajmistry2298","132.2.2.2"));
		System.out.println("Thread :"+Thread.currentThread().getId()+" : "+server.transferAccount("rajmistry2298", "R@mistry" ,"132.2.2.2", "93.3.3.3"));	
	}
}